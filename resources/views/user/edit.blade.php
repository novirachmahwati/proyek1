...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Mengubah User') }}</div>
                    ...
                    <form method="PUT" action="{{ route('user.update',$user->id) }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                name="jabatan" value="{{ $user->jabatan }}" required autocomplete="jabatan" autofocus>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                name="foto" value="{{ $user->file_foto }}" required autocomplete="foto" autofocus>
